...
import "./streeSavingsData.sol";
import "./streeToken/streeToken.sol";
/**
 * @title systemCoin deposit pool.
 * @dev Deposit systemCoin earn interest systemcoin.
 *
 */
contract streeSavings is streeSavingsData,proxyOwner{
    ...
    {
        melt = _melt;
        smelt = new streeToken("Apple Tree Finance Stree Token","STREE",18,address(this));
    }
